...
<head>
	...
	<style type="text/css">
		...
		background: linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, .45)),url("${contextRoot}/banner/password.jpg");
                ...
                <div class="row gutters-60">
                    <div class="col-lg-8">
                        <div class="login-box-layout1">
                            ...
                            <form action="${contextRoot}/users/confirm/password" method="post"class="login-form">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="mb-3">Password</label>
                                        <input required="required" type="password" name="password" class="main-input-box" placeholder="請輸入修改的密碼"/>
                                        <input type="hidden" name="userId" value="${userbean.userId }" class="main-input-box" />
                                      <div class="btn-area">
