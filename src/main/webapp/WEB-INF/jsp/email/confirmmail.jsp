...
<head>
	...
	<style type="text/css">
		...
		background: linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, .45)),url("${contextRoot}/banner/mail.jpg");
                ...
                <div class="row gutters-60">
                    <div class="col-lg-8">
                        <div class="login-box-layout1">
                            ...
                            <form action="${contextRoot}/users/confirm/email" method="post"class="login-form">
                                <div class="row">
                                    <div class="col-md-6">
