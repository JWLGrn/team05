                ...
                <div class="row" id="showrecipe">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="product-box-layout1">
                            <figure class="item-figure"><a href="single-recipe1.html"><img src="recipe/${rL.cookPhoto}"
            ...
            $.ajax(settings).done(function (response) {
                ...
                for(let index in response){
                    ...
                    recipes += '<div class="col-lg-4 col-md-6 col-sm-6 col-12">'
                            +'<div class="product-box-layout1">'
                            +'<figure class="item-figure"><a href="single-recipe1.html"><img src="recipe/'+response[index].cookPhoto+'" alt="Product"></a></figure>'
                            +'<div class="item-content">'
